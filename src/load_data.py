...
def load_weather_data(table_name:str, df):
    ...
    try:
        ...
        logging.info(f"Data loaded into table '{table_name}' successfully. Number of records: {len(df_check)}")
    except Exception as e:
        logging.error(f"Error verifying loaded data for '{table_name}': {e}")
